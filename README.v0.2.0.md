...
- Line numbering (`-n`)
- Diff-highlight and diff-so-fancy emulation modes permitting incremental adoption of delta-specific features (`--features diff-highlight`, `--features diff-so-fancy`)
