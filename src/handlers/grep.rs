...
pub struct GrepLine<'b> {
    ...
    /// One-based byte column of the first search hit, or None when unavailable.
    /// Unlike `submatches`, this stays in source coordinates after `expand_tabs`.
