    ...
    for (op, n) in alignment.coalesced_operations() {
        match op {
            ...
            align::Operation::NoOp => {
                ...
                // Coalesce spaces into the surrounding edit even when the change
                // reaches EOL (the old token-cursor guard skipped tip-of-line
                // spaces; see #2231).
...
mod tests {
            ...
            (
                vec![
                    vec![
                        ...
                        (MinusNoop, " c "),
                        (Deletion, "d"),
                        // Trailing space coalesces into the tip-of-line edit (#2231).
                        (Deletion, " "),
                    ],
    ...
    fn test_word_diff_near_eol_seatbelt() {
        ...
        assert!(
            ...
            "expected insertion annotation near EOL, got {:?}",
            plus
        );
