...
Executables: [Linux](https://github.com/dandavison/delta/releases/download/0.0.14/delta-0.0.14-x86_64-unknown-linux-musl.tar.gz) | [MacOS](https://github.com/dandavison/delta/releases/download/0.0.14/delta-0.0.14-x86_64-apple-darwin.tar.gz) | [Windows](https://github.com/dandavison/delta/releases/download/0.0.14/delta-0.0.14-x86_64-pc-windows-msvc.zip) | [All](https://github.com/dandavison/delta/releases)
